...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container">
            <div class="row mx-3">
                <div data-aos="zoom-in" data-aos-duration="1000" class="testlist col-lg-6 col-12  my-3">
                    <div class=" test bg-light pt-3 pb-5 px-4">
                        <a href="" class="bg-light">
                            <h5 class="text-danger">Master Diabeties Wellness</h5>
                            <p class="text-primary">Parameters included : 38 Tests , Fasting time : 12 hrs </p>
                            <span class="book">Book  Now </span>
                        </a>
                        <span class="price text-white bg-danger  float-left">₹ 150.00 </span>
                    </div>
                </div>    
                <div data-aos="zoom-in" data-aos-duration="1000" class="testlist col-lg-6 col-12  my-3">
                    <div class=" test bg-light pt-3 pb-5 px-4">
